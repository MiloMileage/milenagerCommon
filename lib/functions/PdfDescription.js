...
PdfDescription.fromReport = function (report) {
    ...
    customerDetailsTableSub.body.push([
        ...
        PdfTableSub_1.default.getHeaderTableCell(`${Math.round(report.businessRateInMiles * 1000) / 1000}`),
        PdfTableSub_1.default.getHeaderTableCell(`${Math.round(report.charityRateInMiles * 1000) / 1000}`),
        PdfTableSub_1.default.getHeaderTableCell(`${Math.round(report.movingRateInMiles * 1000) / 1000}`),
        PdfTableSub_1.default.getHeaderTableCell(`${Math.round(report.medicalRateInMiles * 1000) / 1000}`),
    ...
    // Add vehicles table
    pd.content.push(new PdfText_1.default('Report Summary', [], 'subheader', undefined, undefined, undefined, undefined));
    ...
    const summaryLine = new YMReportVehicleLine_1.default('', 0, 0, 0, 0, 0, 0, 0, 0);
    report.vehicleLines.forEach(vl => {
        ...
        vehiclesTableSub.body.push([
            ...
            PdfTableSub_1.default.getHeaderTableCell(`${common_1.milesToMetric(vl.businessMiles, report.isMetricSystem)}`),
            PdfTableSub_1.default.getHeaderTableCell(`${common_1.milesToMetric(vl.personalMiles, report.isMetricSystem)}`),
            PdfTableSub_1.default.getHeaderTableCell(`${common_1.milesToMetric(vl.businessMiles + vl.personalMiles, report.isMetricSystem)}`),
            PdfTableSub_1.default.getHeaderTableCell(`${common_1.metricToMiles(vl.businessValue, report.isMetricSystem)}`),
            PdfTableSub_1.default.getHeaderTableCell(`${common_1.metricToMiles(vl.parkingValue, report.isMetricSystem)}`),
    ...
    vehiclesTableSub.body.push([
        ...
        PdfTableSub_1.default.getHeaderTableCell(`${common_1.milesToMetric(summaryLine.businessMiles, report.isMetricSystem)}`),
        PdfTableSub_1.default.getHeaderTableCell(`${common_1.milesToMetric(summaryLine.personalMiles, report.isMetricSystem)}`),
        PdfTableSub_1.default.getHeaderTableCell(`${common_1.milesToMetric(summaryLine.businessMiles + summaryLine.personalMiles, report.isMetricSystem)}`),
        PdfTableSub_1.default.getHeaderTableCell(`${common_1.metricToMiles(summaryLine.businessValue, report.isMetricSystem)}`),
        PdfTableSub_1.default.getHeaderTableCell(`${common_1.metricToMiles(summaryLine.parkingValue, report.isMetricSystem)}`),
    ...
    const vehiclesTable = new PdfTable_1.default('tableExample', [], customerDetailsTableSub, new PdfLayout_1.default(PdfLayout_1.default.getTableHeaderFillColorFunc(), PdfLayout_1.default.getTableHeaderHLineWidthFunc()));
