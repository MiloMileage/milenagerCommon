...
PdfDescription.fromTransactionReport = function (report, getBase64ImageFromURL) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Add Income Summary
        const incomeTableSub = new PdfTableSub_1.default(['*', '*'], new Array());
        incomeTableSub.body.push([
            PdfTableSub_1.default.getHeaderTableCell('Business'),
            PdfTableSub_1.default.getHeaderTableCell(`Amount`),
        ]);
        Object.keys(report.incomeBySource).map(business => {
            incomeTableSub.body.push([
                PdfTableSub_1.default.getTableCell(business),
                PdfTableSub_1.default.getTableCell(`${report.incomeBySource[business]}`),
            ]);
        });
        ...
        pd.content.push(new PdfText_1.default('Expense Summary', undefined, 'subheader', undefined, undefined, undefined, undefined));
        // Add Expense Summary
        const expenseTableSub = new PdfTableSub_1.default(['*', '*'], new Array());
        ...
        Object.keys(report.expenseByCategory).map(category => {
            expenseTableSub.body.push([
                ...
                PdfTableSub_1.default.getTableCell(`${report.expenseByCategory[category]}`),
            ]);
        });
        ...
        const incomeLogTableSub = new PdfTableSub_1.default([14, 110, 30, 110, 130, 60, 60, 40, 50, 40, '*'], new Array());
        ...
        report.lines.forEach((dl, index) => {
            ...
            incomeLogTableSub.body.push([
                ...
                PdfTableSub_1.default.getTableCell(`${dl.amount}`),
                PdfTableSub_1.default.getTableCell(`${hasReceipt ? `#${receiptsUrls.length}` : ''}`),
            ]);
        });
        ...
        // Add Expense table
        pd.content.push(new PdfText_1.default('Expense Log', undefined, 'subheader', undefined, undefined, undefined, undefined, undefined, 'before'));
        const expenseLogTableSub = new PdfTableSub_1.default([14, 110, 30, 110, 130, 60, 60, 40, 50, 40, '*'], new Array());
        ...
        report.lines.forEach((dl, index) => {
            ...
            expenseLogTableSub.body.push([
                ...
                PdfTableSub_1.default.getTableCell(dl.note),
                PdfTableSub_1.default.getTableCell(`${dl.amount}`),
                PdfTableSub_1.default.getTableCell(`${hasReceipt ? `#${expenseReceiptsUrls.length}` : ''}`),
            ]);
        });
        ...
        pd.content.push(new PdfText_1.default('Receipts', undefined, 'subheader', undefined, undefined, undefined, undefined, undefined, 'before'));
        for (const url of receiptsUrls) {
            pd.content.push(new PdfImage_1.default(yield getBase64ImageFromURL(url), 200, 200));
        }
