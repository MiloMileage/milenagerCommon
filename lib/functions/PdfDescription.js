...
PdfDescription.fromReport = function (report) {
    ...
    report.vehicleBusinessLines.forEach(vl => {
        ...
        businessVehiclesTableSub.body.push([
            ...
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(vl.mileageValue, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(vl.parkingValue, report.isMetricSystem)}`),
    ...
    businessVehiclesTableSub.body.push([
        ...
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(businessSummaryLine.mileageValue, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(businessSummaryLine.parkingValue, report.isMetricSystem)}`),
    ...
    vehiclesTableSub.body.push([
        ...
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(summaryLine.mileageValue, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(summaryLine.parkingValue, report.isMetricSystem)}`),
    ...
    report.lines.forEach(dl => {
        ...
        drivesTableSub.body.push([
            ...
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(dl.value, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(dl.parking, report.isMetricSystem)}`),
    ...
    drivesTableSub.body.push([
        ...
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(drivesSummaryLine.value, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(drivesSummaryLine.parking, report.isMetricSystem)}`),
