...
PdfDescription.fromReport = function (report) {
    ...
    report.vehicleBusinessLines.forEach(vl => {
        ...
        businessVehiclesTableSub.body.push([
            ...
            PdfTableSub_1.default.getTableCell(`${common_1.milesToMetric(vl.mileageValue, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.milesToMetric(vl.parkingValue, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(vl.tollsValue, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(vl.totalValue, report.isMetricSystem)}`),
        ]);
    });
    businessVehiclesTableSub.body.push([
        ...
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(businessSummaryLine.mileageValue, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(businessSummaryLine.parkingValue, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(businessSummaryLine.tollsValue, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(businessSummaryLine.totalValue, report.isMetricSystem)}`),
    ]);
    ...
    vehiclesTableSub.body.push([
        ...
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(summaryLine.mileageValue, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(summaryLine.parkingValue, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(summaryLine.tollsValue, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(summaryLine.totalValue, report.isMetricSystem)}`),
    ]);
    ...
    report.lines.forEach(dl => {
        ...
        drivesTableSub.body.push([
            ...
            PdfTableSub_1.default.getTableCell(`${common_1.milesToMetric(dl.value, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.milesToMetric(dl.parking, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(dl.tolls, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(dl.tolls + dl.parking + dl.value, report.isMetricSystem)}`),
        ]);
    });
    drivesTableSub.body.push([
        PdfTableSub_1.default.getTotalCell(''),
        ...
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(drivesSummaryLine.value, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(drivesSummaryLine.parking, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(drivesSummaryLine.tolls, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(drivesSummaryLine.tolls + drivesSummaryLine.parking + drivesSummaryLine.value, report.isMetricSystem)}`),
    ]);
