...
PdfDescription.getHeaderFunc = (name, dateRanage) => {
    return (currentPage, pageCount) => {
        return new PdfText_1.default(`Mileage Report (${Moment(new Date(dateRanage.endDate)).format('MMMM Do YYYY')} to ${Moment(new Date(dateRanage.startDate)).format('MMMM Do YYYY')}) - ${name}`, [30, 8, 30, 30], 'header', false, true, 'black', undefined, 'left');
    };
};
PdfDescription.fromReport = function (report) {
    ...
    customerDetailsTableSub.body.push([
        ...
        PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(Math.round(report.businessRateInMiles * 1000) / 1000, report.isMetricSystem)} $\\${report.isMetricSystem ? 'km' : 'mi'}`),
        PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(Math.round(report.charityRateInMiles * 1000) / 1000, report.isMetricSystem)} $\\${report.isMetricSystem ? 'km' : 'mi'}`),
        PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(Math.round(report.movingRateInMiles * 1000) / 1000, report.isMetricSystem)} $\\${report.isMetricSystem ? 'km' : 'mi'}`),
        PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(Math.round(report.medicalRateInMiles * 1000) / 1000, report.isMetricSystem)} $\\${report.isMetricSystem ? 'km' : 'mi'}`),
    ...
    report.vehicleBusinessLines.forEach(vl => {
        ...
        businessVehiclesTableSub.body.push([
            ...
            PdfTableSub_1.default.getTableCell(`${vl.odometerRead}`),
            PdfTableSub_1.default.getTableCell(`${common_1.milesToMetric(Math.round(vl.miles * 100) / 100, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.milesToMetric(Math.round(vl.mileageValue * 100) / 100, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.milesToMetric(Math.round(vl.parkingValue * 100) / 100, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(Math.round(vl.tollsValue * 100) / 100, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(Math.round(vl.totalValue * 100) / 100, report.isMetricSystem)}`),
        ]);
    });
    businessVehiclesTableSub.body.push([
        PdfTableSub_1.default.getTotalCell(''),
        PdfTableSub_1.default.getTotalCell('Total'),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(Math.round(businessSummaryLine.miles * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(Math.round(businessSummaryLine.mileageValue * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(Math.round(businessSummaryLine.parkingValue * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(Math.round(businessSummaryLine.tollsValue * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(Math.round(businessSummaryLine.totalValue * 100) / 100, report.isMetricSystem)}`),
    ]);
    ...
    vehiclesTableSub.body.push([
        PdfTableSub_1.default.getTotalCell(''),
        PdfTableSub_1.default.getTotalCell('Total'),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(Math.round(summaryLine.miles * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(Math.round(summaryLine.mileageValue * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(Math.round(summaryLine.parkingValue * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(Math.round(summaryLine.tollsValue * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(Math.round(summaryLine.totalValue * 100) / 100, report.isMetricSystem)}`),
    ]);
    ...
    report.lines.forEach(dl => {
        ...
        drivesTableSub.body.push([
            PdfTableSub_1.default.getTableCell(Moment(new Date(dl.when.startDate)).format('MMMM Do YYYY, h:mm a')),
            PdfTableSub_1.default.getTableCell(dl.purpose),
            PdfTableSub_1.default.getTableCell(dl.fromTo),
            PdfTableSub_1.default.getTableCell(dl.vehicle),
            PdfTableSub_1.default.getTableCell(`${common_1.milesToMetric(Math.round(dl.distanceInMiles * 100) / 100, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.milesToMetric(Math.round(dl.value * 100) / 100, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.milesToMetric(Math.round(dl.parking * 100) / 100, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(Math.round(dl.tolls * 100) / 100, report.isMetricSystem)}`),
            PdfTableSub_1.default.getTableCell(`${common_1.metricToMiles(Math.round((dl.tolls + dl.parking + dl.value) * 100) / 100, report.isMetricSystem)}`),
        ]);
    });
    drivesTableSub.body.push([
        PdfTableSub_1.default.getTotalCell(''),
        ...
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(Math.round(drivesSummaryLine.distanceInMiles * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(Math.round(drivesSummaryLine.value * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.milesToMetric(Math.round(drivesSummaryLine.parking * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(Math.round(drivesSummaryLine.tolls * 100) / 100, report.isMetricSystem)}`),
        PdfTableSub_1.default.getTotalCell(`${common_1.metricToMiles(Math.round((drivesSummaryLine.tolls + drivesSummaryLine.parking + drivesSummaryLine.value) * 100) / 100, report.isMetricSystem)}`),
    ]);
