    ...
    value: function _getReleaseAnimationConfig() {
      ...
      if (leftButtonsActivated) {
        return _extends({}, swipeReleaseAnimationConfig, {
          toValue: {
            x: leftButtons ? leftButtons.length * leftButtonWidth : 0,
            y: 0
          }
      ...
      if (rightButtonsActivated) {
        return _extends({}, swipeReleaseAnimationConfig, {
          toValue: {
            x: rightButtons ? rightButtons.length * rightButtonWidth * -1 : 0,
            y: 0
          }
...
Swipeable.propTypes = {
  ...
  leftActionReleaseAnimationConfig: _propTypes.PropTypes.func,
  ...
  rightActionReleaseAnimationConfig: _propTypes.PropTypes.func,
