...
exports.getSavedLocationIfExist = (personalLocations, location, distance = 0.2) => {
    ...
    Object.keys(personalLocations).forEach(key => {
        ...
        if (YMLocation_1.default.fromObject(currPerLoc.location).distanceFrom(location) < 0.2) {
            result = currPerLoc;
            return;
        }
    });
...
exports.milesToMetric = (num, convert = true) => {
    return convert ? Math.round(num * 16.0934) / 10 : num;
};
exports.metricToMiles = (num, convert = true) => {
