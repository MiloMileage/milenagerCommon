...
class YMUserInfo {
    constructor(displayName, creationDate, lastSignInDate, os, email, secondaryEmails, applePrivateEmail, emailBeforeValidation) {
...
YMUserInfo.fromObject = function (obj) {
    if (obj == null)
        return new YMUserInfo('', new Date(), new Date(), YMOsType.unknown, '', [], undefined, undefined);
    return new YMUserInfo(obj.displayName, obj.creationDate, obj.lastSignInDate, obj.os, obj.email, obj.secondaryEmails, obj.applePrivateEmail, obj.emailBeforeValidation);
};
