...
class YMDrive {
    constructor(driveId, vehicleId, drivePurposeId, miles, origin, dest, driveNotes, isVisible = true, isDeleted = false, 
        ...
        joinedFromIds = [], obj_db_id, lastUpdated, startTimeTimestampUtc, endTimeTimestampUtc, timestampOffsetInSeconds, routeLocations = [], isManual = false, deletionReason = '', isAutoWorkHours = false, isAutoLocation = false, signalSource = 'unknown') {
        this.startTime = () => {
...
YMDrive.fromObject = function (obj) {
    ...
    return new YMDrive(obj.driveId, obj.vehicleId, obj.drivePurposeId, obj.miles, obj.origin, obj.dest, obj.driveNotes, obj.isVisible, obj.isDeleted, obj.joinedFromIds, obj.obj_db_id, new Date().getTime(), obj.startTimeTimestampUtc, obj.endTimeTimestampUtc, obj.timestampOffsetInSeconds, obj.routeLocations, obj.isManual, obj.deletionReason, obj.isAutoWorkHours, obj.isAutoLocation, obj.signalSource);
};
