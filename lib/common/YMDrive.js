...
class YMDrive {
    constructor(driveId, vehicleId, drivePurposeId, miles, origin, dest, startTime, endTime, driveNotes, isVisible = true, isDeleted = false, 
        // tslint:disable-next-line:variable-name
        joinedFromIds = [], obj_db_id, lastUpdated, startTimeTimestampUtc, endTimeTimestampUtc, timestampOffsetInSeconds, routeLocations = [], isManual = false, deletionReason = '', isAutoWorkHours = false, isAutoLocation = false) {
        ...
        this.getPurpose = (userSettings) => {
            return userSettings.purposes.filter(p => p.purposeId === this.drivePurposeId)[0];
        };
        this.getValue = (userSettings, globalSettings) => {
            return YMRate_1.default.getRateForPurposeId(this.drivePurposeId, userSettings, globalSettings, this) * this.miles;
        };
...
YMDrive.fromObject = function (obj) {
    if (obj == null)
        return new YMDrive('', '', '', 0, YMLocation_1.default.fromObject(undefined), YMLocation_1.default.fromObject(undefined), new Date, new Date, YMDriveNotes_1.default.fromObject(undefined), false, false, [], '', 0, 0, 0, 0, [], false, '', false, false);
    // tslint:disable-next-line:max-line-length
    return new YMDrive(obj.driveId, obj.vehicleId, obj.drivePurposeId, obj.miles, obj.origin, obj.dest, obj.startTime, obj.endTime, obj.driveNotes, obj.isVisible, obj.isDeleted, obj.joinedFromIds, obj.obj_db_id, new Date().getTime(), obj.startTimeTimestampUtc, obj.endTimeTimestampUtc, obj.timestampOffsetInSeconds, obj.routeLocations, obj.isManual, obj.deletionReason, obj.isAutoWorkHours, obj.isAutoLocation);
};
