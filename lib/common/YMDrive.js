...
class YMDrive {
    constructor(driveId, autoClassifiedRuleId = '', reportIds = [], vehicleId, drivePurposeId, miles, origin, dest, startTime, endTime, driveNotes, isVisible = true, isDeleted = false, 
        ...
        joinedFromIds = [], obj_db_id, lastUpdated) {
...
YMDrive.fromObject = function (obj) {
    ...
    return new YMDrive(obj.driveId, obj.autoClassifiedRuleId, obj.reportIds, obj.vehicleId, obj.drivePurposeId, obj.miles, obj.origin, obj.dest, obj.startTime, obj.endTime, obj.driveNotes, obj.isVisible, obj.isDeleted, obj.joinedFromIds, obj.obj_db_id, new Date().getTime());
};
// tslint:disable-next-line:member-ordering
YMDrive.joinDrives = function (drives, dbKey) {
    ...
    firstDrive.driveNotes.parkingMoney + secondDrive.driveNotes.parkingMoney, firstDrive.driveNotes.tollMoney + secondDrive.driveNotes.tollMoney), true, false, [firstDrive.driveId, secondDrive.driveId], dbKey, new Date().getTime());
};
