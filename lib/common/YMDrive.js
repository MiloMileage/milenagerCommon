...
class YMDrive {
    constructor(driveId, autoClassifiedRuleId, reportIds, vehicleId, drivePurposeId, miles, origin, dest, startTime, endTime, driveNotes, isVisible = true, isDeleted = false, 
        ...
        joinedFromIds = [], obj_db_id, lastUpdated, startTimeTimestampUtc, endTimeTimestampUtc, timestampOffsetInSeconds, routeLocations = []) {
...
YMDrive.fromObject = function (obj) {
    ...
    return new YMDrive(obj.driveId, obj.autoClassifiedRuleId, obj.reportIds, obj.vehicleId, obj.drivePurposeId, obj.miles, obj.origin, obj.dest, obj.startTime, obj.endTime, obj.driveNotes, obj.isVisible, obj.isDeleted, obj.joinedFromIds, obj.obj_db_id, new Date().getTime(), obj.startTimeTimestampUtc, obj.endTimeTimestampUtc, obj.timestampOffsetInSeconds, obj.routeLocations);
};
