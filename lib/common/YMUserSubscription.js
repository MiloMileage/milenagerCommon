...
class YMUserSubscription {
    constructor(subscriptionType, status, promoCode, expiresAt, apple_original_transaction_id, google_original_purchase_token, stripe_invoice_id) {
        this.status = status;
...
YMUserSubscription.fromObject = function (obj) {
    ...
    return new YMUserSubscription(obj.subscriptionType, obj.status, obj.promoCode, obj.expiresAt, obj.apple_original_transaction_id, obj.google_original_purchase_token, obj.stripe_invoice_id);
};
