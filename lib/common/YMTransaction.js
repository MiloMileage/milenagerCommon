...
class YMTransaction {
    constructor(transactionId, incomeSourceId, expenseCategoryId, date, amount, notes, receipts, merchant, isDeleted) {
...
YMTransaction.fromObject = function (obj) {
    if (obj == null)
        return new YMTransaction('', '', '', '20200101', 0, '', [], undefined, false);
