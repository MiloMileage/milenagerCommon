...
class YMSubscriptionProduct {
    ...
    constructor(introductoryPrice, localizedSymbol, freeMonths, peneltyMonths, periodType, price, peneltyMonthPrice, iosSubscription, androidSubscription, lateChargeMonths, productId) {
