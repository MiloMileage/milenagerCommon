...
class YMDateRange {
    ...
    isMonthRange() {
        return (Moment(this.startDate).isSame(Moment(this.startDate).startOf('month').startOf('day')) && Moment(this.endDate).isSame(Moment(this.endDate).endOf('month').endOf('day')) ||
