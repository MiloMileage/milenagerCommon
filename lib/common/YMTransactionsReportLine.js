...
class YMTransactionsReportLine {
    constructor(when, amount, note, isExpense, merchantName, expenseCategory, incomeSource, receiptImageUrl, isBusiness) {
        this.when = when;
        this.amount = amount;
        this.note = note;
