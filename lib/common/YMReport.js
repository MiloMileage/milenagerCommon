...
class YMReport {
    constructor(reportName, dateCreated, name, project, customerDetails, details, userSettings, globalSettings, isMetricSystem, dateRange, lines, vehicleBusinessLines, vehiclePersonalLines, reportId, csvLink, pdfLink, isOutsideOfSubscriptionPeriod, moneySymbol) {
        ...
        if (this.userSettings.country === YMUserSettings_1.YMCountry.CA) {
            ...
            this.rates.push({ purpose: `business (after ${this.getDistanceFormated(fromToDistanceInMilesCA, this.userSettings)})`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.business, this.userSettings, this.globalSettings), this.userSettings.personalSettings.isMetricSystem, fromToDistanceInMilesCA + 1)}` });
            this.rates.push({ purpose: `personal`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.personal, this.userSettings, this.globalSettings), this.userSettings.personalSettings.isMetricSystem)}` });
        }
    ...
    getDistanceFormated(miles, userSettings) {
        const dist = common_1.milesToMetric(miles, userSettings.personalSettings.isMetricSystem);
...
YMReport.fromObject = function (obj) {
    if (obj == null)
        return new YMReport('', new Date(), '', '', '', '', YMUserSettings_1.default.fromObject(undefined), YMGlobalUserSettings_1.default.fromObject(undefined), false, YMDateRange_1.default.fromObject(undefined), [], [], [], '', '', '', false, '$');
