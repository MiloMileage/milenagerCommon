...
class YMReport {
    constructor(reportName, dateCreated, name, project, customerDetails, details, userSettings, globalSettings, isMetricSystem, dateRange, lines, vehicleBusinessLines, vehiclePersonalLines, reportId, csvLink, pdfLink, isOutsideOfSubscriptionPeriod, moneySymbol, approvalRequestId, isApproved, denyReason) {
        ...
        if (this.userSettings.country === YMUserSettings_1.YMCountry.US) {
            this.rates.push({ purpose: `business (general)`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.business, this.userSettings, this.globalSettings, undefined, undefined, this.dateRange.getStartDateLocal(true)), this.userSettings.personalSettings.isMetricSystem)}` });
            this.rates.push({ purpose: `medical`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.medical, this.userSettings, this.globalSettings, undefined, undefined, this.dateRange.getStartDateLocal(true)), this.userSettings.personalSettings.isMetricSystem)}` });
            this.rates.push({ purpose: `charity`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.charity, this.userSettings, this.globalSettings, undefined, undefined, this.dateRange.getStartDateLocal(true)), this.userSettings.personalSettings.isMetricSystem)}` });
            this.rates.push({ purpose: `moving`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.moving, this.userSettings, this.globalSettings, undefined, undefined, this.dateRange.getStartDateLocal(true)), this.userSettings.personalSettings.isMetricSystem)}` });
            this.rates.push({ purpose: `personal`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.personal, this.userSettings, this.globalSettings, undefined, undefined, this.dateRange.getStartDateLocal(true)), this.userSettings.personalSettings.isMetricSystem)}` });
        }
        if (this.userSettings.country === YMUserSettings_1.YMCountry.CA) {
            const fromToDistanceInMilesCA = common_1.metricToMiles(5000);
            this.rates.push({ purpose: `business (first ${this.getDistanceFormated(fromToDistanceInMilesCA, this.userSettings)})`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.business, this.userSettings, this.globalSettings, undefined, undefined, this.dateRange.getStartDateLocal(true)), this.userSettings.personalSettings.isMetricSystem)}` });
            this.rates.push({ purpose: `business (after ${this.getDistanceFormated(fromToDistanceInMilesCA, this.userSettings)})`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.business, this.userSettings, this.globalSettings, undefined, fromToDistanceInMilesCA + 1, this.dateRange.getStartDateLocal(true)), this.userSettings.personalSettings.isMetricSystem)}` });
            this.rates.push({ purpose: `personal`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.personal, this.userSettings, this.globalSettings, undefined, undefined, this.dateRange.getStartDateLocal(true)), this.userSettings.personalSettings.isMetricSystem)}` });
        }
        ...
        if (this.userSettings.country === YMUserSettings_1.YMCountry.UK) {
            ...
            this.rates.push({ purpose: `motorcycle - business`, rate: `${common_1.milesToMetric(YMRate_1.default.GetRates(undefined, this.globalSettings.ukRates, this.dateRange.getStartDateLocal(true))[YMRate_1.default.BUSINESS].getRateFromMileage(0, YMVehicle_1.YMVehicleType.motorcycle), this.userSettings.personalSettings.isMetricSystem)}` });
            this.rates.push({ purpose: `bicycle - business`, rate: `${common_1.milesToMetric(YMRate_1.default.GetRates(undefined, this.globalSettings.ukRates, this.dateRange.getStartDateLocal(true))[YMRate_1.default.BUSINESS].getRateFromMileage(0, YMVehicle_1.YMVehicleType.bicycle), this.userSettings.personalSettings.isMetricSystem)}` });
            this.rates.push({ purpose: `personal`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(YMPurpose_1.default.defaultPuposesIds.personal, this.userSettings, this.globalSettings, undefined, undefined, this.dateRange.getStartDateLocal(true)), this.userSettings.personalSettings.isMetricSystem)}` });
        }
        if (this.userSettings.country === YMUserSettings_1.YMCountry.CUSTOME || this.userSettings.country === YMUserSettings_1.YMCountry.UNKNOWN) {
            this.userSettings.purposes.map(p => {
                this.rates.push({ purpose: `${p.name}`, rate: `${common_1.milesToMetric(YMRate_1.default.getRateForPurposeId(p.purposeId, this.userSettings, this.globalSettings, undefined, undefined, this.dateRange.getStartDateLocal(true)), this.userSettings.personalSettings.isMetricSystem)}` });
            });
        }
    }
