...
class YMCompanyInvite {
    constructor(status, sentTime, corpId, email, role, lastUpdatedTime, userId) {
        this.status = status;
...
YMCompanyInvite.fromObject = function (obj) {
    ...
    return new YMCompanyInvite(obj.status, obj.sentTime, obj.corpId, obj.email, obj.role, obj.lastUpdatedTime, obj.userId);
};
