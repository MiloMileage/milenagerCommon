...
class YMReportLine {
    constructor(when, purpose, rate, fromTo, fromToPersonalized, vehicle, distanceInMiles, value, parking, tolls, note) {
        this.when = when;
