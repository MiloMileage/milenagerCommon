...
class YMUserSettings {
    constructor(vehicles = [], personalRates = [], purposes = [], notificationSettings = [], personalSettings = new YMPersonalSettings_1.default(true, '0'), autoRules = [], workingHours = [], isWorkingHoursEnabled = false, isAutoRulesEnabled = false, isCustomClassificationEnabled = false, customClassifications = []) {
