...
class YMUserSettings {
    constructor(vehicles = [], personalRates = [], purposes = [], notificationSettings = [], personalSettings = new YMPersonalSettings_1.default(true, '0'), autoRules = [], workingHours = [], isWorkingHoursEnabled = false, isAutoRulesEnabled = false, isCustomClassificationEnabled = false, customClassifications = [], fcmToken = '') {
        ...
        this.purposes = purposes.map(x => YMPurpose_1.default.fromObject(purposes));
    ...
    static fromObject(obj) {
        ...
        return new YMUserSettings(obj.vehicles, obj.personalRates, obj.purposes, obj.notificationSettings, obj.personalSettings, obj.autoRules, obj.workingHours, obj.isWorkingHoursEnabled, obj.isAutoRulesEnabled, obj.isCustomClassificationEnabled, obj.customClassifications, obj.fcmToken);
    }
