...
class YMUserSettings {
    constructor(vehicles = [], personalRates = [], purposes = [], notificationSettings = [], personalSettings = new YMPersonalSettings_1.default(false, '1'), autoRules = [], workingHours = [], isWorkingHoursEnabled = false, isAutoRulesEnabled = true, isCustomClassificationEnabled = false, customClassifications = []) {
